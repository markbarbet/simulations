...
os.chdir('C:\\Users\\RodgerCornell\\Google Drive (rodger.cornell@gmail.com)\\Burke Group\\Codes\\TMRP codes\\RDX')

gas = ct.Solution('RDX.cti')
# Inlet gas conditions
reactorTemperature = 1500 #Kelvin
reactorPressure = 1#1.046138*ct.one_atm #in atm. This equals 1.06 bars
concentrations = {'RDX': 1}
